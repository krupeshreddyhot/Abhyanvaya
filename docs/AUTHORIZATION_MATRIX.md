...
Stable strings include: `Students.View`, `Students.Manage`, `Attendance.View`, `Attendance.Manage`, `Reports.View`, `Dashboard.View`, `Master.View`, `Setup.Subjects.Manage`, `Setup.Departments.Manage`, `Setup.Staff.Manage`, `Setup.Lookups.Manage`, `Setup.Courses.Manage`, `Setup.Groups.Manage`, `Setup.Semesters.Manage`, `Organization.Manage`, `Scheduling.View`, `Scheduling.Manage`, `Scheduling.Department.View`, `Scheduling.Department.Manage`, `Scheduling.RoomAvailability.View`, `Scheduling.RoomAvailability.Manage`, `Scheduling.FacultyAvailability.View`, `Scheduling.FacultyAvailability.Manage`, `Scheduling.Template.View`, `Scheduling.Template.Manage`, `Scheduling.FacultyPreferences.View`, `Scheduling.FacultyPreferences.Manage`, `Scheduling.RoomFeatures.View`, `Scheduling.RoomFeatures.Manage`, `Scheduling.SubjectDelivery.View`, `Scheduling.SubjectDelivery.Manage`, `Scheduling.HolidayTypes.View`, `Scheduling.HolidayTypes.Manage`, `Scheduling.Timetable.View`, `Scheduling.Timetable.Manage`, `Scheduling.Version.View`, `Scheduling.Version.Manage`, `Scheduling.Review`, `Scheduling.Approve`, `Scheduling.Publish`, `Scheduling.Archive`, `Scheduling.Clone`, `Scheduling.History.View`.
