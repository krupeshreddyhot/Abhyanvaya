...
namespace Abhyanvaya.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260802074305_AI30_Phase2B_ConflictDetection")]
    partial class AI30_Phase2B_ConflictDetection
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 8, 2, 7, 43, 2, 963, DateTimeKind.Utc).AddTicks(6333),
                            GroupId = 1,
                            IsDeleted = false,
