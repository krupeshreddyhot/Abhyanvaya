...
namespace Abhyanvaya.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260802095308_AI30_Phase2B6_OptimizationReadiness")]
    partial class AI30_Phase2B6_OptimizationReadiness
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 8, 2, 9, 53, 0, 300, DateTimeKind.Utc).AddTicks(8555),
                            GroupId = 1,
                            IsDeleted = false,
