...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260405081029_FixStudentIdConflict")]
    partial class FixStudentIdConflict
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 5, 8, 10, 27, 137, DateTimeKind.Utc).AddTicks(3628),
                            GroupId = 1,
                            IsDeleted = false,
