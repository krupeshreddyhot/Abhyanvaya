...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260416191217_CollegeShortNameAndParent")]
    partial class CollegeShortNameAndParent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 16, 19, 12, 14, 516, DateTimeKind.Utc).AddTicks(4431),
                            GroupId = 1,
                            IsDeleted = false,
