...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260717080634_AddEnrollmentStorageRecord")]
    partial class AddEnrollmentStorageRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 17, 8, 6, 28, 716, DateTimeKind.Utc).AddTicks(1496),
                            GroupId = 1,
                            IsDeleted = false,
