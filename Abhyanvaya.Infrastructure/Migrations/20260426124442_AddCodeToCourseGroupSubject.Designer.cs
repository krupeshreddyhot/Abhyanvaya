...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260426124442_AddCodeToCourseGroupSubject")]
    partial class AddCodeToCourseGroupSubject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.Subject", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CourseId", "GroupId", "SemesterId", "Code");
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 26, 12, 44, 37, 714, DateTimeKind.Utc).AddTicks(850),
                            GroupId = 1,
                            IsDeleted = false,
