...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260702164213_AddStudentFaceEmbedding")]
    partial class AddStudentFaceEmbedding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 2, 16, 42, 8, 561, DateTimeKind.Utc).AddTicks(4799),
                            GroupId = 1,
                            IsDeleted = false,
