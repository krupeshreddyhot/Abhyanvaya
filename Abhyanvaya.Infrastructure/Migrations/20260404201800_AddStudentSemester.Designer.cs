...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260404201800_AddStudentSemester")]
    partial class AddStudentSemester
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 4, 20, 17, 58, 799, DateTimeKind.Utc).AddTicks(8342),
                            GroupId = 1,
                            IsDeleted = false,
