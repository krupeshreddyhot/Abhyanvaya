...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260717191916_AddEnrollmentBackgroundProcessing")]
    partial class AddEnrollmentBackgroundProcessing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 17, 19, 19, 13, 468, DateTimeKind.Utc).AddTicks(5034),
                            GroupId = 1,
                            IsDeleted = false,
