...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260418100354_CollegeLogoAccess")]
    partial class CollegeLogoAccess
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 18, 10, 3, 51, 149, DateTimeKind.Utc).AddTicks(6568),
                            GroupId = 1,
                            IsDeleted = false,
