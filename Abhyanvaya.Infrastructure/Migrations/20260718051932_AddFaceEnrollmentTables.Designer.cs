...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260718051932_AddFaceEnrollmentTables")]
    partial class AddFaceEnrollmentTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 18, 5, 19, 29, 609, DateTimeKind.Utc).AddTicks(2798),
                            GroupId = 1,
                            IsDeleted = false,
