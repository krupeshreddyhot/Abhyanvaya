...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260405130422_AddAttendanceLockNew")]
    partial class AddAttendanceLockNew
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 5, 13, 4, 21, 26, DateTimeKind.Utc).AddTicks(4500),
                            GroupId = 1,
                            IsDeleted = false,
