...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628175415_AddAttendanceDetail")]
    partial class AddAttendanceDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 17, 54, 13, 886, DateTimeKind.Utc).AddTicks(3615),
                            GroupId = 1,
                            IsDeleted = false,
