...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260716060756_AddStudentEnrollmentTables")]
    partial class AddStudentEnrollmentTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 16, 6, 7, 53, 303, DateTimeKind.Utc).AddTicks(4676),
                            GroupId = 1,
                            IsDeleted = false,
