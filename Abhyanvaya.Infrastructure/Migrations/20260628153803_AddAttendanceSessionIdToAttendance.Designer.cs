...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628153803_AddAttendanceSessionIdToAttendance")]
    partial class AddAttendanceSessionIdToAttendance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 15, 37, 59, 544, DateTimeKind.Utc).AddTicks(5191),
                            GroupId = 1,
                            IsDeleted = false,
