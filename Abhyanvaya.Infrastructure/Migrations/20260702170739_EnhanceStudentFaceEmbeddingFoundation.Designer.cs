...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260702170739_EnhanceStudentFaceEmbeddingFoundation")]
    partial class EnhanceStudentFaceEmbeddingFoundation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 2, 17, 7, 37, 802, DateTimeKind.Utc).AddTicks(3725),
                            GroupId = 1,
                            IsDeleted = false,
