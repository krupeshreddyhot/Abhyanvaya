...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260416035019_CollegeUniversityCodeForLogin")]
    partial class CollegeUniversityCodeForLogin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 16, 3, 50, 16, 725, DateTimeKind.Utc).AddTicks(2674),
                            GroupId = 1,
                            IsDeleted = false,
