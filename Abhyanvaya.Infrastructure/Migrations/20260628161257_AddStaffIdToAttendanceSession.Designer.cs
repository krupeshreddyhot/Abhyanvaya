...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628161257_AddStaffIdToAttendanceSession")]
    partial class AddStaffIdToAttendanceSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 16, 12, 56, 287, DateTimeKind.Utc).AddTicks(1025),
                            GroupId = 1,
                            IsDeleted = false,
