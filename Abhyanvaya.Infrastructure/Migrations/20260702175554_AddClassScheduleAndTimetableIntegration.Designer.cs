...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260702175554_AddClassScheduleAndTimetableIntegration")]
    partial class AddClassScheduleAndTimetableIntegration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.AttendanceSession", b =>
                {
                    ...
                    b.Property<short?>("ImageOrientation")
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 2, 17, 55, 45, 598, DateTimeKind.Utc).AddTicks(1582),
                            GroupId = 1,
                            IsDeleted = false,
