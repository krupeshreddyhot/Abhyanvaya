...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    partial class AI30_Phase1_EnterpriseSchedulingFoundation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.Scheduling.SubjectAllocation", b =>
                {
                    ...
                    b.HasIndex("TenantId", "AcademicYearId", "SubjectId", "CourseId", "GroupId", "SemesterId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 8, 1, 14, 36, 51, 205, DateTimeKind.Utc).AddTicks(3344),
                            GroupId = 1,
                            IsDeleted = false,
