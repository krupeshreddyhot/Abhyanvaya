...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260415184732_TenantScopedIndexes")]
    partial class TenantScopedIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 15, 18, 47, 31, 873, DateTimeKind.Utc).AddTicks(7186),
                            GroupId = 1,
                            IsDeleted = false,
