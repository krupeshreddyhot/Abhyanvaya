...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260701165128_AddRecognitionSnapshotJsonToAttendanceDetail")]
    partial class AddRecognitionSnapshotJsonToAttendanceDetail
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.AttendanceRecognition", b =>
                {
                    ...
                    b.HasIndex("AttendanceSessionId", "FaceNumber")
                        .IsUnique()
                        .HasDatabaseName("IX_AttendanceRecognition_Session_FaceNumber");
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.AttendanceRecognitionReviewHistory", b =>
                {
                    ...
                    b.HasIndex("RecognitionId")
                        .HasDatabaseName("IX_AttendanceRecognitionReviewHistory_RecognitionId");
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 1, 16, 51, 24, 469, DateTimeKind.Utc).AddTicks(9948),
                            GroupId = 1,
                            IsDeleted = false,
