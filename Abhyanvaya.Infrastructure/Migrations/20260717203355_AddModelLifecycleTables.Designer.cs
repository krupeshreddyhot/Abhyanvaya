...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260717203355_AddModelLifecycleTables")]
    partial class AddModelLifecycleTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 17, 20, 33, 50, 584, DateTimeKind.Utc).AddTicks(5110),
                            GroupId = 1,
                            IsDeleted = false,
