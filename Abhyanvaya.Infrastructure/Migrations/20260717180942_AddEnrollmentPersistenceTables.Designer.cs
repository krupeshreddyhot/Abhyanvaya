...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260717180942_AddEnrollmentPersistenceTables")]
    partial class AddEnrollmentPersistenceTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 17, 18, 9, 41, 160, DateTimeKind.Utc).AddTicks(9843),
                            GroupId = 1,
                            IsDeleted = false,
