...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628171440_AddAttendanceRecognition")]
    partial class AddAttendanceRecognition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.AttendanceRecognition", b =>
                {
                    ...
                    b.HasIndex("StudentId")
                        .HasDatabaseName("IX_AttendanceRecognition_StudentId");
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 17, 14, 39, 169, DateTimeKind.Utc).AddTicks(9791),
                            GroupId = 1,
                            IsDeleted = false,
