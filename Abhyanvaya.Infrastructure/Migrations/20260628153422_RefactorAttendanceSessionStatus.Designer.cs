...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628153422_RefactorAttendanceSessionStatus")]
    partial class RefactorAttendanceSessionStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 15, 34, 20, 969, DateTimeKind.Utc).AddTicks(606),
                            GroupId = 1,
                            IsDeleted = false,
