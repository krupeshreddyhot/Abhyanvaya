...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260701155907_EnhanceAttendanceSessionBusinessModel")]
    partial class EnhanceAttendanceSessionBusinessModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 1, 15, 59, 3, 576, DateTimeKind.Utc).AddTicks(5182),
                            GroupId = 1,
                            IsDeleted = false,
