...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260503092757_AddUserPasswordManagementFields")]
    partial class AddUserPasswordManagementFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 5, 3, 9, 27, 55, 475, DateTimeKind.Utc).AddTicks(669),
                            GroupId = 1,
                            IsDeleted = false,
