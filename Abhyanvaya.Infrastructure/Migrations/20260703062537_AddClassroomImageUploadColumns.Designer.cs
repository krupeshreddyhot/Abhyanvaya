...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260703062537_AddClassroomImageUploadColumns")]
    partial class AddClassroomImageUploadColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 7, 3, 6, 25, 35, 940, DateTimeKind.Utc).AddTicks(9540),
                            GroupId = 1,
                            IsDeleted = false,
