...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628152318_EnhanceAttendanceSession")]
    partial class EnhanceAttendanceSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 15, 23, 16, 371, DateTimeKind.Utc).AddTicks(7643),
                            GroupId = 1,
                            IsDeleted = false,
