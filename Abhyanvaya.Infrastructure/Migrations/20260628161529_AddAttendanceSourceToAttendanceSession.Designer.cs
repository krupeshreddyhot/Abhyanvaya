...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260628161529_AddAttendanceSourceToAttendanceSession")]
    partial class AddAttendanceSourceToAttendanceSession
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 6, 28, 16, 15, 25, 839, DateTimeKind.Utc).AddTicks(6039),
                            GroupId = 1,
                            IsDeleted = false,
