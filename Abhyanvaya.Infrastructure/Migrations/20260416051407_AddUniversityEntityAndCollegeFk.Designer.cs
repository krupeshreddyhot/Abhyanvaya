...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260416051407_AddUniversityEntityAndCollegeFk")]
    partial class AddUniversityEntityAndCollegeFk
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 16, 5, 14, 4, 378, DateTimeKind.Utc).AddTicks(6212),
                            GroupId = 1,
                            IsDeleted = false,
