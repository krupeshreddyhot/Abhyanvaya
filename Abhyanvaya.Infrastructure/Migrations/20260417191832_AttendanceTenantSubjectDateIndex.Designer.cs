...
namespace Abhyanvaya.Infrastructure.Migrations
{
    ...
    [Migration("20260417191832_AttendanceTenantSubjectDateIndex")]
    partial class AttendanceTenantSubjectDateIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Abhyanvaya.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CourseId = 1,
                            CreatedDate = new DateTime(2026, 4, 17, 19, 18, 31, 906, DateTimeKind.Utc).AddTicks(6541),
                            GroupId = 1,
                            IsDeleted = false,
