...
$destRoot = "D:\Resheta\AttendenceProject\CursonModifiedFiles\AI Attandance\AI31.8.2"
...
$core = @(
  "abhyanvaya-ui\src\components\dashboards\executiveInformationArchitecture.ts",
...
$docs = @(
  "docs\AI31_8_2_EXECUTIVE_INFORMATION_ARCHITECTURE.md",
  "docs\AI31_8_2_KPI_RATIONALIZATION.md",
  "docs\AI31_8_2_DASHBOARD_LAYOUT.md",
  "docs\AI31_8_2_UX_REVIEW.md",
  "docs\AI31_8_2_OPERATIONAL_FLOW.md",
  "docs\AI31_8_2_IMPLEMENTATION_SUMMARY.md",
  "scripts\AI31_8_2_Copy.ps1"
)
